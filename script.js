...
function rand_char() {
    ...
    for (let i = 1; i <= 11 - count; i++) {
        ...
        if (i == (4 - count) || i == (8 - count)) {
            parag.innerText = parag.innerText.concat(" ").concat(String.fromCharCode(selector));
            i++
        }
        else {
...
function rand_char_2() {
    ...
    for (let i = 1; i <= 12 - count; i++) {
        ...
        if (i == (5 - count) || i == (9 - count)) {
            parag.innerText = (String.fromCharCode(selector).concat(" ")).concat(parag.innerText);
            i++;
        }
        else {
    ...
    if (count == 4 || count == 8)
        count++;
    parag.innerText = parag.innerText.concat(final_str_2.substring(11 - count + 1, 11));
}
...
function grd_adjust() {
    ...
    if (window.innerWidth > window.innerHeight) {
        ...
        for (let i = 0; i < blocks_arr.length; i++) {
            ...
            blocks_arr[i].style.width = blocks_arr[i].style.height = `${new_blk_width}px`;
        }
    }
    else {
    ...
    cutting_line.style.left = `${((window.innerWidth - new_width) / 2) + new_blk_width * 0.1}px`;
...
function stop_ani() {
    ...
    let oxo_txt = setInterval(() => {
        if (i <= 11) {
            ...
            if (i == 3 || i == 7)
                parag.innerText = parag.innerText.concat(" ").concat(final_str_2.substring(11 - i, 11));
            else
                parag.innerText = parag.innerText.concat(final_str_2.substring(11 - i, 11));
            i++;
        }
    }, 25);
...
function box_filling(event) {//To fill the boxes
    ...
    O_X.style.fontSize = `${0.7 * blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2)}px`;
    document.getElementsByTagName("style")[0].innerHTML+=`@keyframes char_appearence{
        0%{
            font-size:0px;
        }
        80%
        {
            font-size:${1.25*(0.7 * blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2))}px;
        }
        100%
        {
            font-size:${0.7 * blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2)}px;
        }
    }`;
...
function checking_func(pos_arr) {
    if (pos_arr.indexOf(0) != -1) {
        if (pos_arr.indexOf(1) != -1 && pos_arr.indexOf(2) != -1) {
            winner = 1;
            cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) / 2}px`;
            ...
            cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.1}px`;
            cutting_line.style.left = `${((window.innerWidth - box.style.width.substring(0, box.style.width.length - 2)) / 2) + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) / 2 - 4}px`;
            ...
            cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.25}px`;
            cutting_line.style.left = `${((window.innerWidth - box.style.width.substring(0, box.style.width.length - 2)) / 2) + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) / 4}px`;
            cutting_line.style.width = `${cutting_line.style.width.substring(0, cutting_line.style.width.length - 2) * 1.3}px`;
    ...
    if (pos_arr.indexOf(1) != -1) {
        if (pos_arr.indexOf(4) != -1 && pos_arr.indexOf(7) != -1) {
            ...
            cutting_line.style.transformOrigin = "left";
            cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.1}px`;
            cutting_line.style.left = `${((window.innerWidth - box.style.width.substring(0, box.style.width.length - 2)) / 2) + 3 * blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) / 2}px`;
    ...
    if (pos_arr.indexOf(2) != -1) {
        if (pos_arr.indexOf(4) != -1 && pos_arr.indexOf(6) != -1) {
            ...
            cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.25}px`;
            cutting_line.style.left = `${((window.innerWidth - box.style.width.substring(0, box.style.width.length - 2)) / 2) + 11 * blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) / 4}px`;
            cutting_line.style.width = `${cutting_line.style.width.substring(0, cutting_line.style.width.length - 2) * 1.3}px`;
            cutting_line.style.height = "4px";
            ...
            cutting_line.style.transformOrigin = "left";
            cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.1}px`;
            cutting_line.style.left = `${((window.innerWidth + 8 - box.style.width.substring(0, box.style.width.length - 2)) / 2) + 5 * blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) / 2}px`;
    ...
    if (winner == 1) {
        ...
        result.innerText = `${blocks_arr[pos_arr[0]].innerText} has won 🥳`;
        result.setAttribute("id", "result");
        if (blocks_arr[pos_arr[0]].innerText == "O")
...
function linehor_3() {
    cutting_line.style.top = `${108 + (blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2)) * 2.5}px`;
}
function linever_1() {
    cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.1}px`;
    cutting_line.style.left = `${((window.innerWidth - box.style.width.substring(0, box.style.width.length - 2)) / 2) + (blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) / 2) - 4}px`;
...
function linever_2() {
    cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.1}px`;
    cutting_line.style.left = `${((window.innerWidth - box.style.width.substring(0, box.style.width.length - 2)) / 2) + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 1.5}px`;
}
function linever_3() {
    cutting_line.style.top = `${100 + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 0.1}px`;
    cutting_line.style.left = `${((window.innerWidth + 8 - box.style.width.substring(0, box.style.width.length - 2)) / 2) + blocks_arr[0].style.width.substring(0, blocks_arr[0].style.width.length - 2) * 2.5}px`;
}
...
{
    if(100+new_width+document.getElementById("result_div").scrollHeight+0.05*window.innerHeight+20>window.innerHeight)
    attri.style.top = `${100+new_width+document.getElementById("result_div").scrollHeight+0.05*window.innerHeight+20}px`;
    else{
